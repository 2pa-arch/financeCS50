...
def register():
    ...
    if request.method == "POST":
        ...
        if len(rows):
            apology("This username is already in use.")
        hash_pass = generate_password_hash(request.form.get("password"))

        db.execute("INSERT INTO users (username, hash) VALUES( :username, :hash_pass )", username=request.form.get("username"), hash_pass=hash_pass)
